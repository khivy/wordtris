...
export class BoardPhysics {
    ...
    constructor(rows: number, cols: number) {
        ...
        this.boardCellMatrix[6][3].char = 'z'
        this.boardCellMatrix[5][3].char = 'z'
        this.boardCellMatrix[4][3].char = 'z'
        this.boardCellMatrix[3][3].char = 'z'
        this.boardCellMatrix[2][3].char = 'z'
        this.boardCellMatrix[1][3].char = 'z'

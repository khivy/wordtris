...
export const Prompt = React.memo(
    (
        { children, keydownCallback }: {
            children: ReactNode;
            keydownCallback: ({ code }: { code: string }) => void;
        },
    ) => {
        ...
        return (
            <div style={promptContainerStyle}>
                ...
                {children}
                <Keys
                    totalSize={promptSize + paddingSize}
...
export const Keys = React.memo(
    (
        { totalSize, keydownCallback }: {
            totalSize: number;
            keydownCallback: ({ code }: { code: string }) => void;
        },
    ) => {
        const [isSmallScreen, setIsSmallScreen] = useState(
            globalThis.innerWidth < SMALL_WINDOW_WIDTH_THRESHOLD,
        );
        ...
        return (
            <div style={containerStyle}>
                <div style={guideCombinedBlockStyle}>
                    <div style={guideKeyBlockStyle}>
                        <div
                            style={keyDivWrapper}
                            onClick={() =>
                                keydownCallback({ code: "ArrowLeft" })}
                        >
                            <Key
                                char={"←"}
                                keyHeight={keyHeight}
                        ...
                        <div
                            style={keyDivWrapper}
                            onClick={() =>
                                keydownCallback({ code: "ArrowDown" })}
                        >
                            <Key
                                char={"↓"}
                                keyHeight={keyHeight}
                        ...
                        <div
                            style={keyDivWrapper}
                            onClick={() =>
                                keydownCallback({ code: "ArrowRight" })}
                        >
                            <Key
                                char={"→"}
                                keyHeight={keyHeight}
                ...
                <div style={guideCombinedBlockStyle}>
                    <div
                        style={guideKeyBlockStyle}
                        onClick={() => keydownCallback({ code: "KeyZ" })}
                    >
                        <Key
                            char={"z"}
                            keyHeight={keyHeight}
                ...
                <div style={guideCombinedBlockStyle}>
                    <div
                        style={guideKeyBlockStyle}
                        onClick={() => keydownCallback({ code: "KeyX" })}
                    >
                        <Key
                            char={"x"}
                            keyHeight={keyHeight}
                ...
                <div style={guideCombinedBlockStyle}>
                    <div
                        style={guideKeyBlockStyle}
                        onClick={() => keydownCallback({ code: "Space" })}
                    >
                        <Key
                            char={"space"}
                            keyHeight={keyHeight}
...
export const Key = React.memo(
    (
        ...
        const keyStyle = {
            ...
            width: char === "space"
                ? `${adjustedKeyHeight * 2.5}vmin`
                : `${adjustedKeyHeight}vmin`,
            background: "white",
